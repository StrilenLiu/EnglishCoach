...
**当前版本 / Current version: v2.19.0**

---

## v2.19.0 — 2026-09-11

**十个联网引擎 · 嗓音名单改成各家自己报的 · 每个引擎都能测**

*Ten keyed online engines, voice lists straight from the providers, and a test button on each*
...
**译文标注音标/拼音 · 自定义 API 引擎 · 关闭可最小化到托盘 · 标题区分 CPU/GPU 版**

*Phonetics under translations, custom API engines, close-to-tray, and CPU/GPU in the title*
